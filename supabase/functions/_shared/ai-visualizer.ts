...
export async function transformYardPhoto(
    ...
    try {
        ...
        const promptEdit = "Only edit the image, do not generate new. Take this typical Toronto backyard image and replace only the old grass with fresh artificial turf, free of debris. Do not touch anything else in the picture. Output resolution 1024x1024.";

        console.log(`Sending Generation Request to ${MODEL_NAME}...`);
